...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-4 text-gray-800">Data Tabel Fakta Sales</h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?query=dwoadw1" style="height:100% ;width:100%; border:none; text-align:center;">
                        </iframe>
                        <br>
